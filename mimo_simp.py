...
#----------------IDENTIFICATION---------------------------------------------
 ...
 #---------------------------------------------------------------------------   
    ...
    y = b*y_1 + a_1*u_1 + a_2*v_1  + noise + disturbance   
    ...
    quality.append([(1 - np.sum(recent_error_list[0]))**2, (1 - np.sum(recent_error_list[1]))**2, min_quality])
