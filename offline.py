# -*- coding: utf-8 -*-
"""
Created on Thu May 12 20:51:56 2016
...
for i, t in enumerate(tspan):
    ...
    dist = 0.0*square_wave(s,t)
    dist2 =0.0*square_wave(s2,t)
...
#            break
    ...
    u = step(0.5,-0.3,50,t)#u_1 + Kc*((er-e_1) + (T/tau_i)*er + (tau_d/T)*(er - 2*e_1 + e_2)) 
    v = step(0.2,0.5,70,t)#v_1 + Kcb*((eb-eb_1) + (T/taub_i)*eb + (taub_d/T)*(eb - 2*eb_1 + eb_2)) 
